...
export const TableNow = function TableNow({
    ...
    return <TableContainer table={table} fetchNextPage={fetchNextPage} totalRowCount={totalRowCount} />;
};
    ...
    const fetchMoreOnBottomReached = React.useCallback(
        (containerRefElement?: HTMLDivElement | null) => {
            if (containerRefElement) {
                ...
                if (scrollHeight - scrollTop - clientHeight < 500 && rows.length < totalRowCount) {
                    fetchNextPage();
                }
            }
        },
        [rows.length, totalRowCount, fetchNextPage]
    );
